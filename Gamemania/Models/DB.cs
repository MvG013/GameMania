...
namespace Gamemania.Models
{
    public class DB
    {
        ...
        public void Bestteling(int ProductID , decimal Prijs)
        {
            //try
            //{
            if (_conn.State != System.Data.ConnectionState.Open)
            ...
            OracleCommand cmd = new OracleCommand
            {
                ...
                CommandText = "INSERT INTO BESTELLING (PRODUCTID , PRIJS , AANTAL) VALUES(:ProductID , :Prijs , :Aantal)"
            };
        ...
        //public void Bestelling(int ProductID, int GebruikerID)
        //{
        //    //try
        //    //{
        //    if (_conn.State != System.Data.ConnectionState.Open)
